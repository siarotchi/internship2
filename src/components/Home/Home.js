      ...
      <div className="home-container">
        ...
        <section className="introduction-section">
          ...
          <p>
            ...
            correctly and on time. Have no problems with the routine and the large volume of work. If i'm seting goals,
            i can donate a lot to achieve it. Thanks to my open manner of communication, it is easy for me to make new
        ...
        <section className="domain-section">
          ...
          <p>
            Working on a network, i began to communicate with people much more, acquiring new communication skills. Then
            i consolidate my ability to solve problems, because there were many more of them on the network. The ability
            to find solutions by any means without fear of new actions. When i became a Senior operator, i'm acquired a
            new mentoring skill. I've trained the operator from scratch until my replacement, which gave me experience
            and understanding of the complexity of the training process. And teamwork, where i learned to divide work by
        ...
        <section className="core-section">
          ...
          <p>
            ...
            FlexBox, Microsoft Office, SQL.
          </p>
          <p>
            &#10003; <u>Tools:</u> Visual Studio Code, jQuery, Npm, Chrome DevTools, Sass, Gulp.
          </p>
          <p>
            &#10003; <u>Techniques &amp; Methods:</u> Agile Methodologies (SCRUM and XP).
          </p>
        </section>
        ...
        <section className="questions-section">
          ...
          <p>
            ...
            thought-provoking, honest, humble and enthusiastic environment where innovation can exist. That’s why i'm
            here.
          </p>
        </section>
